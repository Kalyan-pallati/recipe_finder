                        ...
                        <form onSubmit={handleSignup} className="animate-fadeIn">
                            ...
                            <div className="space-y-5">
                                <div>
                                    ...
                                    <input type="name" value={name} onChange={(e) => setName(e.target.value)} className="w-full px-3 py-2 bg-[#f6f8fa] border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:bg-white outline-none transition" required />
                                </div>
