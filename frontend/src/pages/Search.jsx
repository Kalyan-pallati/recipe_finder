  ...
  useEffect(() => {
    async function loadSaved() {
      ...
      if (res.ok) {
        ...
        setSavedIds(data.map((r) => r.recipe_id)); // store recipe IDs only
      }
    }
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-6 py-8 flex gap-8">
        ...
        <aside className="w-72 md:w-80 lg:w-96 shrink-0 bg-white p-6 rounded-lg shadow-sm">
          ...
          <input type="text" className="w-full mb-3 px-2 py-2 border rounded"
              ...
              <div className="mt-6 flex items-center justify-center gap-4">
                <button
                  ...
                  className={`px-4 py-2 rounded ${
                    canPrev ? "bg-white border" : "bg-gray-100 text-gray-400"
                  }`}
                >
                  Prev
                </button>
                ...
                <button
                  ...
                  onClick={handleNext}
                  className={`px-4 py-2 rounded ${
                    canNext ? "bg-white border" : "bg-gray-100 text-gray-400"
                  }`}
                >
                  Next
                </button>
